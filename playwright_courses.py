...
with sync_playwright() as playwright:
    ...
    expect(courses_list_empty_view_title).to_be_visible()
    ...
    expect(courses_list_empty_view_description).to_have_text('Results from the load test pipeline will be displayed here')